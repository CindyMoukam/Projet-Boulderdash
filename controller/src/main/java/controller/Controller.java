...
import musicGame.Music;

/**
 * The class Controller which control the interactions of the model ,the view and the entity
 * @author Cindy
 */
...
public final class Controller implements IController, IOrderPerformer {
    ...
    /**
     * movePlayer method : To move the player up , down , right ,left or stay motionless
     */
    ...
    /**
     * killPlayer method : Condition of death of the player
     */
    ...
    /**
     * WinPlayer method : Condition of win of the player
     */
